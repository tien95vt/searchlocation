  ...
  <div class="panel-group shadowpanel-2 wow slideInRight" data-wow-offset="150" style="visibility: visible; animation-name: slideInRight;">
   ...
   <div class="panel-body">
    ...
    <div class="newpost col-md-12">
      <div class="col-md-5">
        <img src="{{asset('upload/picture/post/').'/'.$valuePost->photo}}" class="img-responsive img-thumbnail"> 
      </div>
      <div class="col-md-7 post-content" style="margin-top: 20px">
        <a  href="{{route('show_post')}}/{{$valuePost->id}}">{{$valuePost->title}}</a>
      </div>
    </div>
